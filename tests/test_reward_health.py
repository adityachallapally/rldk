...
class TestRewardHealth:
    ...
    def test_health_custom_columns(self):
        ...
        custom_data = self.sample_data.rename(columns={
            'reward_mean': 'custom_reward',
            'step': 'custom_step'
        })
        
        report = health(
            custom_data, 
            reward_col='custom_reward',
            step_col='custom_step'
        )
    ...
    def test_health_shortcut_detection(self):
        ...
        shortcut_data['reward_mean'] = shortcut_data['tokens_out'] * 0.01  # Strong correlation
    ...
    def test_health_label_leakage_detection(self):
        ...
        leakage_data['reward_mean'] = leakage_data['epoch'] * 0.1  # Correlated with epoch
...
class TestCalibration:
    ...
    def test_analyze_calibration_no_data(self):
        ...
        no_calibration_data = self.calibration_data.drop(columns=['human_preference', 'ground_truth'])
...
class TestDriftDetection:
    ...
    def test_detect_reward_drift_missing_columns(self):
        ...
        with pytest.raises(ValueError):
            detect_reward_drift(incomplete_run, self.reference_data, 'reward_mean', 'step')
    ...
    def test_detect_reward_drift_different_distributions(self):
        ...
        different_reference['reward_mean'] = np.random.normal(1.0, 0.1, len(different_reference))
    ...
    def test_detect_reward_drift_similar_distributions(self):
        ...
        similar_reference['reward_mean'] = np.random.normal(0.5, 0.2, len(similar_reference))
