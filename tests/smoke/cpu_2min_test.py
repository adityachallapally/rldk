...
def run_rldk_analysis(output_dir: str) -> bool:
    ...
    det_cmd = f"rldk check-determinism --cmd 'python scripts/tasks/summarization_helpfulness/train_summarization.py --steps 10' --compare reward_mean --output-dir {output_dir}_determinism"
...
def main():
    ...
    training_cmd = "python scripts/tasks/summarization_helpfulness/train_summarization.py --steps 50 --output_dir smoke_test_outputs"
