...
class TestSeedRoundtrip:
    ...
    def test_numpy_random_roundtrip(self):
        ...
        # Set a seed and generate some random numbers
        tracker.set_seeds(42)
        random_numbers_1 = np.random.random(10).tolist()
    ...
    def test_torch_random_roundtrip(self):
        ...
        # Set a seed and generate some random numbers
        tracker.set_seeds(42)
        random_tensor_1 = torch.rand(10).tolist()
    ...
    def test_cuda_random_roundtrip(self):
        ...
        # Set a seed and generate some random numbers
        tracker.set_seeds(42)
        random_tensor_1 = torch.cuda.rand(10).cpu().tolist()
    ...
    def test_all_rngs_roundtrip(self):
        ...
        # Set a seed and generate some random numbers
        tracker.set_seeds(42)
        python_nums_1 = [random.random() for _ in range(5)]
        numpy_nums_1 = np.random.random(5).tolist()
        torch_nums_1 = torch.rand(5).tolist()
