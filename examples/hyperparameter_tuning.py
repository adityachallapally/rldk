...
def main():
    ...
    print(f"   Random search: 20 trials")
    ...
    if best_grid_result['avg_reward'] > best_random_result['avg_reward']:
        print(f"   🥇 Grid search found better hyperparameters!")
        best_overall = best_grid_result
    else:
        print(f"   🥇 Random search found better hyperparameters!")
    ...
    print(f"   - ./hyperparameter_tuning_results.json - Detailed results")
    print(f"   - ./hyperparameter_tuning_plots.png - Analysis plots")
