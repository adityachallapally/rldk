...
def test_imports():
    ...
    try:
        ...
        try:
            ...
            print("   3. export CUDA_HOME=/usr/lib/nvidia-cuda-toolkit")
            print("   4. export PATH=$CUDA_HOME/bin:$PATH")
            print("   5. python3 -m venv openrlhf_env")
            print("   6. source openrlhf_env/bin/activate")
            print("   7. pip install torch torchvision --index-url https://download.pytorch.org/whl/cu121")
            print("   8. git clone https://github.com/OpenRLHF/OpenRLHF.git")
            print("   9. cd OpenRLHF && pip install -e . --no-deps")
