...
Full report saved to: `data/fixtures/reference_expected/reward_analysis/reward_health_card.md`
Calibration plots saved to: `data/fixtures/reference_expected/reward_analysis/calibration_plots.png`
