...
python scripts/tasks/summarization_helpfulness/train_summarization.py --steps 50

# Run just the safety task
python scripts/tasks/refusal_safety/train_refusal_safety.py --steps 100

# Run just the code generation task
python scripts/tasks/code_fix_prompts/train_code_fix.py --steps 150
```
...
- **Task Guides**: `scripts/tasks/*/README.md`
