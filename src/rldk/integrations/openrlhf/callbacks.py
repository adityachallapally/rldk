...
try:
    import openrlhf
    from openrlhf.trainer import PPOTrainer, DDPOTrainer, CPOTrainer
...
class OpenRLHFCallback:
    ...
    def _collect_training_metrics(self, trainer):
        ...
        try:
            ...
            warnings.warn(f"Failed to collect training metrics: {e}")
    ...
    def _collect_resource_metrics(self):
        ...
        try:
            ...
            warnings.warn(f"Failed to collect resource metrics: {e}")
    ...
    def _collect_distributed_metrics(self):
        ...
        try:
            ...
            warnings.warn(f"Failed to collect distributed metrics: {e}")
    ...
    def _collect_resource_metrics(self):
        ...
        for device_id in range(self.gpu_count):
            try:
                ...
                warnings.warn(f"Failed to collect metrics for GPU {device_id}: {e}")
