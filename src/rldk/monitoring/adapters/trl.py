...
from ...core.utils.error_handling import AdapterError, ValidationError
...
class TRLAdapter(BaseAdapter):
    ...
    def load(self) -> pd.DataFrame:
        ...
        try:
            from ...pipelines.ingest.training_metrics_normalizer import standardize_training_metrics
    ...
    def _load_jsonl_file(self, path: Path) -> pd.DataFrame:
        ...
        if format_hint == "event_stream":
            from ...pipelines.ingest.stream_normalizer import stream_jsonl_to_dataframe
