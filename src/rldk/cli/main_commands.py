"""Main CLI commands available at the top level."""
...
# Import forensics modules for legacy commands
from .forensics import (
    forensics_compare_runs,
    forensics_diff_ckpt,
    forensics_env_audit,
    forensics_log_scan,
    forensics_doctor,
...
# Import reward modules for legacy commands
