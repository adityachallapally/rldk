...
def compare_models(model_a_dir: str, model_b_dir: str, prompts: List[str]) -> Dict[str, Any]:
...
def compute_slice_deltas(prompts: List[str], scores_a: List[float], scores_b: List[float]) -> Dict[str, Dict[str, Any]]:
